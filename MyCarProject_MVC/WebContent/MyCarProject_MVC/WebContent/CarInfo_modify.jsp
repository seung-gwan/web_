...
<table>
	...
	<tr>
		...
		<td><input type="text" name="member_car" value="${Carinfo_view.member_car }"></td>
		
	</tr>
	<tr>
		<td>차량 번호</td>
		<td><input type="text" name="car_Num" value="${Carinfo_view.car_Num }"></td>
	</tr>
	<tr>
		<td>주행거리</td>
		<td><input type="text" name="car_kM" value="${Carinfo_view.car_kM }"></td>
	</tr>	
	<tr>
		<td>생산년도</td>
		<td><input type="text" name="car_ProductY" value="${Carinfo_view.car_ProductY }"></td>
	</tr>
	<tr>
		<td>색상</td>
		<td><input type="text" name="car_color" value="${Carinfo_view.car_color }"></td>
	</tr>
	<tr>
		<td>제조사</td>
		<td><input type="text" name="car_brand" value="${Carinfo_view.car_brand }"></td>
	</tr>
	<tr>
		<td>타입</td>
