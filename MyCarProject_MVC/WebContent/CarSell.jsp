...
.container .inputBox .input2[type="submit"]:hover {
  ...
  <body>
	...
	<div class="container">
	  <h2 id="h2">자세한 상담을 위해 고객님의 연락처를 남겨주세요.</h2>
	  <form action="???" method="Post" name="form" id="form">
	    <div class="inputBox">
	      <input class="input2" type="text" name="car_name" id="car_name" required>
	      <span id="span">차량명<span style="color:red;">*</span></span>
	    </div>
	    <div class="inputBox">
	      <input class="input2" type="text" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)' name="car_number" id="car_number" required>
	      <span id="span">주행거리<span style="color:red">*</span></span>
	    </div>
	    <div class="inputBox">
	      <input class="input2" type="text" name="sin_name" id="sin_name" required>
	      <span id="span">신청자 명<span style="color:red">*</span></span>
	    </div>
	     <div class="inputBox">
	      <input class="input2" type="text" maxlength="11" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)' name="p_number" id="p_number" required>
	      <span id="span">휴대폰 번호<span style="color:red">*</span></span>
	    </div>
	    
	    <div class="inputBox">
	      <input class="input2" type="password" name="password" id="password" required>
	      <span id="span">비밀번호<span style="color:red">*</span></span>
	    </div>
